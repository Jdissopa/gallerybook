...
class GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post :create, gallery: { description: @gallery.description, gallert_name: @gallery.gallert_name, user_id: @gallery.user_id }
    end
  ...
  test "should update gallery" do
    patch :update, id: @gallery, gallery: { description: @gallery.description, gallert_name: @gallery.gallert_name, user_id: @gallery.user_id }
    assert_redirected_to gallery_path(assigns(:gallery))
  end
